const config = {
  ...
  timeline: {
    ...
    circles: [
      ...
      { website: "pub3.com", datetime: "2023-10-01 18:00" },
      { website: "adv8.com", datetime: "2023-10-01 19:00" },
...
app.getTopicColors = () => ({
  ...
  politics: color(255, 69, 0), // Orange Red
  finance: color(34, 139, 34), // Forest Green
  environment: color(0, 128, 128), // Teal
  history: color(160, 82, 45), // Sienna
  art: color(173, 216, 230), // Light Blue
});
